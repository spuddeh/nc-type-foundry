...
${cardRow(PUNCT, n => PUNCT_LABEL[n])}
  ...
  <ul class="notes">
    <li><b>Two canonical systems.</b> The favicon Z belongs to the monogram system (uniform strokes, 45° cuts), the font Z to the type system (26/17, 20×14). Neither should be "harmonised" to the other.</li>
